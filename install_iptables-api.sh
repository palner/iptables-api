...
wget https://github.com/palner/iptables-api/raw/main/iptables-api &>/dev/null
if [ "$?" -eq "0" ]
then
  echo "  -o downloaded"
else
...
cp /usr/local/src/iptables-api/iptables-api /usr/local/iptables-api/iptables-api
